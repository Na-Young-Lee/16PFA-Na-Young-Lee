...
# ex09CashCard.py 모듈 안의 check_balnce() 함수를 호풀
# ex09CashCard.py 모듈의 balance_won 값으 읽어 반환
...
chk_bal("CashCard_module 잔액 확인", CashCard_module)
chk_bal("mySistereCard_module 잔액 확인", mySistersCard_module)

# 그러나 이런 식으로는 한 장의 카드만 만들 수 있다

print("CashCard_module : %s" % CashCard_module)
print("mySistereCard_module : %s" % mySistersCard_module)
